"""
URL configuration for loxa project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Loxa API",
        default_version="v1",
        description="Online live classroom API (sessions, courses, lessons, assets, auth, etc.)",
        terms_of_service="https://example.com/terms/",  # optional
        contact=openapi.Contact(email="support@loxa.local"),
        license=openapi.License(name="Proprietary"),
    ),
    public=True,  # ← allow public access to docs
